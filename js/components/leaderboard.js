			...
			content : [{
				...
				cb : function () {
					...
					self.data.updateRank = function () {
						SB.io.post('http://www.boing2.dev/score.php?a=rank', function (r) {
				...
				// SB.io.post('http://www.boing2.dev/score.php?a=store', function (r) {
				// 	console.debug(r);
			...
			content : [{
				...
				cb : function () {
					...
					SB.events.on($elf, "#PARAM{bEvent}", function () {
						...
						!!name && SB.io.post('http://www.boing2.dev/score.php?a=store', function (r) {
							alert('saved');
