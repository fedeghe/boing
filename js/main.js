			...
			G.panel = SB.Widgzard.render({
				 ...
				 */
				{
						...
						content : [{
							...
							tag : "h2",
							html :"DaisyBoing v.0.1 <sub>39</sub>",
		...
		*/
		SB.s = {
			...
			snd : function (score, name) {
				...
				SB.io.post("http://www.boing2.dev/score.php?a=pre", function (r) {
			...
			getLeaderboard : function (f) {
				SB.io.getJson('http://www.boing2.dev/score.php?a=lb', f);
			}
		};
	}();
